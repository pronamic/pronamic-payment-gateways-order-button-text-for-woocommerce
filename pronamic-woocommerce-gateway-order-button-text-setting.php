 ...
 *
 * @package   PronamicWooCommerceGatewayOrderButtonTextSetting
 * @author    Pronamic
 ...
 * Text Domain: pronamic-woocommerce-gateway-order-button-text-setting
 * Domain Path: /languages/
 * License:     Proprietary
 * License URI: https://www.pronamic.shop/product/pronamic-woocommerce-gateway-order-button-text-setting/
 * Update URI:  https://wp.pronamic.directory/plugins/pronamic-woocommerce-gateway-order-button-text-setting/
 */

/**
 * Pronamic WooCommerce Gateway Order Button Text Setting Plugin class
 */
class PronamicWooCommerceGatewayOrderButtonTextSettingPlugin {
	/**
	 * Setup.
	 * 
	 * @return void
...
( new PronamicWooCommerceGatewayOrderButtonTextSettingPlugin() )->setup();
